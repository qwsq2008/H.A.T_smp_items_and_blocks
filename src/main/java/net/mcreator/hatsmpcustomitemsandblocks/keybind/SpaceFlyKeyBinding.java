...
import net.mcreator.hatsmpcustomitemsandblocks.procedures.IronLaunchProcedure;
...
public class SpaceFlyKeyBinding extends HatSmpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SpaceFlyKeyBinding(HatSmpModElements instance) {
		super(instance, 60);
		...
		if (type == 0) {
			{
				...
				IronLaunchProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
