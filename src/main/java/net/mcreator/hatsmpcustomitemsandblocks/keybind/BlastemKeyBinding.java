...
import net.mcreator.hatsmpcustomitemsandblocks.procedures.BlasterProcedure;
...
public class BlastemKeyBinding extends HatSmpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public BlastemKeyBinding(HatSmpModElements instance) {
		super(instance, 66);
	...
	public void initElements() {
		keys = new KeyBinding("key.hat_smp.blastem", GLFW.GLFW_KEY_Z, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				BlasterProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
