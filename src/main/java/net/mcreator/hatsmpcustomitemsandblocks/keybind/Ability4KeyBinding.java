...
import net.mcreator.hatsmpcustomitemsandblocks.procedures.Apility4pProcedure;
...
public class Ability4KeyBinding extends HatSmpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public Ability4KeyBinding(HatSmpModElements instance) {
		super(instance, 53);
	...
	public void initElements() {
		keys = new KeyBinding("key.hat_smp.ability_4", GLFW.GLFW_KEY_KP_4, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				Apility4pProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
