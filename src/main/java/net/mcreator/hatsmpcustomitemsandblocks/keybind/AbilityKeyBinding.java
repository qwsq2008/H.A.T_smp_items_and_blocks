...
import net.mcreator.hatsmpcustomitemsandblocks.procedures.Ability1Procedure;
...
public class AbilityKeyBinding extends HatSmpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public AbilityKeyBinding(HatSmpModElements instance) {
		super(instance, 39);
	...
	public void initElements() {
		keys = new KeyBinding("key.hat_smp.ability1", GLFW.GLFW_KEY_KP_1, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				Ability1Procedure.executeProcedure($_dependencies);
			}
		}
	}
}
