...
import net.mcreator.hatsmpcustomitemsandblocks.procedures.Ability3pProcedure;
...
public class Ability3KeyBinding extends HatSmpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public Ability3KeyBinding(HatSmpModElements instance) {
		super(instance, 52);
	...
	public void initElements() {
		keys = new KeyBinding("key.hat_smp.ability_3", GLFW.GLFW_KEY_KP_3, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				Ability3pProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
