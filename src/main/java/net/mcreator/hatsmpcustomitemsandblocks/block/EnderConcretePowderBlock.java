...
public class EnderConcretePowderBlock extends HatSmpModElements.ModElement {
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Seems powerful... but how so?"));
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(EnderConcretePowderBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EnderConcretePowderBlock.block, (int) (1)));
		}
