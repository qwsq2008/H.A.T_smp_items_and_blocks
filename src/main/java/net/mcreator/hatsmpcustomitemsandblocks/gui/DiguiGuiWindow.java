...
@OnlyIn(Dist.CLIENT)
public class DiguiGuiWindow extends ContainerScreen<DiguiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public DiguiGuiWindow(DiguiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 58, this.guiTop + 34, 50, 20, new StringTextComponent("craft"), e -> {
			if (true) {
